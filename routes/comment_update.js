...
router.post('/', function(req, res, next) {
        var comment_idx=req.comment_idx;
         ...
         connection.query('update comment set comment_contents=?,comment_regdate=? where comment_idx=? ;', [req.body.comment_contents, req.body.omment_regdate,req.comment_idx], function (error, info) {
        if (error == null) {
